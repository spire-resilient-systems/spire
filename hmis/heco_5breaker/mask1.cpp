...
static int generated_defineMask(PARAM *p)
{
  ...
  pvSetGeometry(p,trip_b54,483,447,80,30);
  ...
  pvSetGeometry(p,line_leftbus,186,222,170,4);
  ...
  pvSetGeometry(p,box_b55,240,393,100,50);
  ...
  pvSetGeometry(p,box_b54,471,393,100,50);
  ...
  pvSetGeometry(p,line_rightbus,453,222,166,4);
