...
void modelInit()
{
  ...
  d->point_arr[0].id = -1;
  d->point_arr[1].id = dial1;
  d->point_arr[2].id = dial2;
  d->point_arr[3].id = -1;
  ...
  d->br_read_arr[8].id  = opened_b54;
    strncpy(d->br_read_arr[8].to_str, "B54 Opened", sizeof(d->br_read_arr[6].to_str));
  d->br_read_arr[9].id  = closed_b54;
    strncpy(d->br_read_arr[9].to_str, "B54 Closed", sizeof(d->br_read_arr[7].to_str));
  d->br_read_arr[10].id  = opened_b55;
    strncpy(d->br_read_arr[10].to_str, "B55 Opened", sizeof(d->br_read_arr[8].to_str));
  d->br_read_arr[11].id  = closed_b55;
    strncpy(d->br_read_arr[11].to_str, "B55 Closed", sizeof(d->br_read_arr[9].to_str));
  ...
  d->br_write_arr[8].id  = trip_b54;
    strncpy(d->br_write_arr[8].to_str, "Trip B54", sizeof(d->br_write_arr[6].to_str));
  d->br_write_arr[9].id  = close_b54;
    strncpy(d->br_write_arr[9].to_str, "Close B54", sizeof(d->br_write_arr[7].to_str));
  d->br_write_arr[10].id  = trip_b55;
    strncpy(d->br_write_arr[10].to_str, "Trip B55", sizeof(d->br_write_arr[8].to_str));
  d->br_write_arr[11].id  = close_b55;
    strncpy(d->br_write_arr[11].to_str, "Close B55", sizeof(d->br_write_arr[9].to_str));
