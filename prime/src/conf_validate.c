/* This is a modification of Prime's validate.c for use with Confidential
			      ...
			      int32u site_id, signed_message *mess) 
{
  ...
  if (sig_type == VAL_SIG_TYPE_CLIENT) {
    ...
    /*
      MK: Following code is deprecated. Check the next TC Verification.
          (Keeping code here just for comparison)
    */
